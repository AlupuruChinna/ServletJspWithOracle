...
<div>
<header>
	<iframe name="topframe" src="adminhome.jsp" width="1300" height="200" frameborder="0"  class="frame-area" scrolling="no" >
	</iframe>
</header>
	<article>
		<iframe name="leftframe" src="" width="176" height="550"scrolling="no" frameborder="0">
	</iframe>
	</article>
		<iframe name="rightframe" width="82%" height="535" class="frame-area" align="middle"no" frameborder="0">
	</iframe>
<hr>
        <footer>
            <div class="row">
