...
<body>
		...
		<%
			...
			try
			{
				...
				ResultSet rs=st.executeQuery("select email from admindata where afname='"+name+"'");
				...
				while(rs.next())
				{
					...
					else
					{
						...
						ps=DBConnect.getLocalDBConnection().prepareStatement("update admindata set email=? where afname=?");
						ps.setString(1,pwd1);
						ps.setString(2,name);
						ps.executeUpdate();
