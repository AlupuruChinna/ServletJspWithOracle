...
<body>
	...
	<form class="w3-container w3-card-4" action="CreateTaskResp">
  <h4>Respond about your task</h4>
	<%System.out.print(request.getParameter("file_name")); %>
  <select class="w3-select" name="fname">
    ...
    try {
       ...
       %>
    		<option><%out.print(rs.getString(2)); %>
    		<%-- </option> <%out.print(rs.getString(1)); %> --%>
    <%
    	}}
        catch(Exception e)
        {
...
<p><button class="w3-btn w3-teal">Send</button></p>
</form>
