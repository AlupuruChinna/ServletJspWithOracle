...
<body>
		...
		<%
			...
			try
			{
				...
				ResultSet rs=st.executeQuery("select password from userdata where fname='"+name+"'");
				...
				while(rs.next())
				{
					...
					else
					{
						...
						ps=DBConnect.getLocalDBConnection().prepareStatement("update userdata set password=? where fname=?");
						ps.setString(1,pwd1);
						ps.setString(2,name);
						ps.executeUpdate();
