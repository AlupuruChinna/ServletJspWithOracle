...
//		System.out.print(pwd);
		...
		ResultSet rs=st.executeQuery("select fname,sname,email,gender,password from userdata where password='"+pwd+"' and fname='"+c+"'");
		...
		while(rs.next())
		{
			...
			{
				out.println("<h3>Your personal profile is :</h3>");
