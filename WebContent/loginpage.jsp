...
<pre><h5 align="left" id="timedemo"></h5></pre></h5><h3 class="w3-myfont" align="right">	Welcome to Mr. <%=uname %></h3>
<center></center>	
<p class="lufont"> 
<ul>
  <li><a href="userhomeslideshow.jsp" target="rightframe" >Home</a></li>
  <li><a href="userinbox.jsp" target="leftframe" >Inbox</a></li>
  <li><a href="useractions.jsp" target="leftframe" >Actions</a></li>
  <li><a href="userabout1.jsp" target="leftframe" >Profile</a></li>
